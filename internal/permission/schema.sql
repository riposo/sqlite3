...
CREATE INDEX IF NOT EXISTS idx_permission_paths_permission ON permission_paths(permission);

CREATE INDEX IF NOT EXISTS idx_permission_paths_principal ON permission_paths(principal);
...
INSERT INTO
  metainfo
VALUES
  ('permission_schema_version', '1') ON CONFLICT (name) DO NOTHING;
